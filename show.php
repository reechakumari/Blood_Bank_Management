...
<table width="80%" border-collapse="collapse" align="center" font-family=" arial" background-color="#dddddd">
  <tr>
    <td width="74" >Patient Id</td>
    <td width="199">Patient Name</td>
    <td width="63">Blood Group</td>
	<td width="74">Unit of blood require</td>
    <td width="199">Gender</td>
    <td width="63">Hospital Name</td>
...
?>
  <tr>
    <td><?php echo $tmp['patient_id'];?></td>
    <td><?php echo $tmp['patientname'];?></td>
    <td><?php echo $tmp['bloodgroup'];?></td>
	<td><?php echo $tmp['unit_of_blood_require'];?></td>
    <td><?php echo $tmp['gender'];?></td>
    <td><?php echo $tmp['hospitalname'];?></td>
